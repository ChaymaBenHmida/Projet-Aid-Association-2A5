...
bool Dons::ajouter()
{
    ...
    QString res=QString::number(id);
          query.prepare("INSERT INTO dons ( nom,prenom,role,id,produit,montant,dateD) "
                        "VALUES ( :nom,:prenom,:role,:id,:produit,:montant,:dateD)");
...
bool Dons::modifier(int id)
{
   ...
   query.prepare("UPDATE dons SET  nom=:nom ,prenom=:prenom,role=:role, montant=:montant,produit=:produit,DateD=:DateD WHERE id=:id");
